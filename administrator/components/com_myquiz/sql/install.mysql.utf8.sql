...
INSERT INTO `#__myQuiz_quiz` (`title`, `description`) VALUES
	('Quiz Number 1', 'A series of questions about this image'),
	('Quiz Number 2', 'A series of questions about another image');
	
	
	
INSERT INTO `#__myQuiz_question` (`quizId`, `questionNumber`, `questionDescription`, `feedback`) VALUES
	(1, 1, 'What is going on in this image?', 'The correct choice for this answer is c as there are reasons'),
	(1, 2, 'How many things are in this image?', 'The correct choice for this answer is a for reasons described'),
	(2, 1, 'Where are the bits in this image?', 'The correct choice for this answer is b. You should know this'),
	(2, 2, 'Where would everyone be in this image?', 'The correct choice for this answer is d. I cant say why');
